...
function Digit({ place, value, height, digitStyle }) {
  ...
  const animatedValue = useSpring(valueRoundedToPlace, { stiffness: 100, damping: 15 });
...
export default function Counter({
  ...
  // Fallback configuration if places is not provided
  const calculatedPlaces = places || [...valStr].map((ch, i, a) => {
    if (ch === '.') {
      return '.';
    } else {
      return (
